...
# Setting up your Jetson as SBC
 ...
 The last line
 `make xconfig`
 will bring up the GUI for kernel configuration. Enable the ACM and cp210 ports. The ACM port is for the OpenCR board, and the cp210 is for the LIDAR (either the HLS-LFCD LIDAR or the RPLidar A1/A2)
